            ...
            <form @submit.prevent="submit">
                <div class="mt-8">
                    ...
                    <input 
                        ...
                        type="email" 
                        class="block w-full bg-[#27272A] border border-[#3F3F46] 
                            rounded text-white px-4 py-2 placeholder:text-zinc-500 text-sm" 
                    />
                </div>
                ...
                <!-- sign up button -->
                <div>
                    <button class="w-full mt-4 bg-[#FFAC00] rounded-full px-4 py-2 flex justify-center items-center space-x-2">
                        <span>Sign Up</span>
                        <ArrowRight />
                    </button>
                </div>
